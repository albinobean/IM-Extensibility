...
class ApiClient {
    constructor() {
         ...
         * @type {String}
         * @default http://localhost/api/rest/1.1
         */
        this.basePath = 'http://localhost/api/rest/1.1'.replace(/\/+$/, '');
        ...
        this.authentications = {
            'IdentityClient': {type: 'oauth2'},
            'IdentityUser': {type: 'oauth2'},
            'Legacy': {type: 'oauth2'}
        }
