...
/**
 * The GatewayDTO model module.
 * @module model/GatewayDTO
 * @version 1.0.0
 */
class GatewayDTO {
    /**
     * Constructs a new <code>GatewayDTO</code>.
     * @alias module:model/GatewayDTO
     */
    constructor() { 
        
        GatewayDTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GatewayDTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GatewayDTO} obj Optional instance to populate.
     * @return {module:model/GatewayDTO} The populated <code>GatewayDTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GatewayDTO();
 ...
 * @member {Number} id
 */
GatewayDTO.prototype['id'] = undefined;

/**
 * @member {String} name
 */
GatewayDTO.prototype['name'] = undefined;

/**
 * Web URL alias of the gateway
 * @member {String} alias
 */
GatewayDTO.prototype['alias'] = undefined;

/**
 * @member {String} dnis
 */
GatewayDTO.prototype['dnis'] = undefined;
