...
/**
 * The SurveyInitOutboundMergeBindings model module.
 * @module model/SurveyInitOutboundMergeBindings
 * @version 1.0.0
 */
class SurveyInitOutboundMergeBindings {
    /**
     * Constructs a new <code>SurveyInitOutboundMergeBindings</code>.
     * @alias module:model/SurveyInitOutboundMergeBindings
     */
    constructor() { 
        
        SurveyInitOutboundMergeBindings.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SurveyInitOutboundMergeBindings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SurveyInitOutboundMergeBindings} obj Optional instance to populate.
     * @return {module:model/SurveyInitOutboundMergeBindings} The populated <code>SurveyInitOutboundMergeBindings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SurveyInitOutboundMergeBindings();
 ...
 * @member {String} key
 */
SurveyInitOutboundMergeBindings.prototype['key'] = undefined;

/**
 * @member {String} value
 */
SurveyInitOutboundMergeBindings.prototype['value'] = undefined;
...
export default SurveyInitOutboundMergeBindings;
