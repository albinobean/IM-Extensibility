...
/**
 * The SurveyInitInboundParameters model module.
 * @module model/SurveyInitInboundParameters
 * @version 1.0.0
 */
class SurveyInitInboundParameters {
    /**
     * Constructs a new <code>SurveyInitInboundParameters</code>.
     * @alias module:model/SurveyInitInboundParameters
     */
    constructor() { 
        
        SurveyInitInboundParameters.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SurveyInitInboundParameters</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SurveyInitInboundParameters} obj Optional instance to populate.
     * @return {module:model/SurveyInitInboundParameters} The populated <code>SurveyInitInboundParameters</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SurveyInitInboundParameters();
 ...
 * @member {String} key
 */
SurveyInitInboundParameters.prototype['key'] = undefined;

/**
 * @member {String} value
 */
SurveyInitInboundParameters.prototype['value'] = undefined;
...
export default SurveyInitInboundParameters;
