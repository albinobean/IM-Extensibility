...
/**
 * The LocalizedStringDTO model module.
 * @module model/LocalizedStringDTO
 * @version 1.0.0
 */
class LocalizedStringDTO {
    /**
     * Constructs a new <code>LocalizedStringDTO</code>.
     * @alias module:model/LocalizedStringDTO
     */
    constructor() { 
        
        LocalizedStringDTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LocalizedStringDTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LocalizedStringDTO} obj Optional instance to populate.
     * @return {module:model/LocalizedStringDTO} The populated <code>LocalizedStringDTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LocalizedStringDTO();
 ...
 */
LocalizedStringDTO.prototype['locale'] = undefined;

/**
 * @member {String} value
 */
LocalizedStringDTO.prototype['value'] = undefined;
...
export default LocalizedStringDTO;
