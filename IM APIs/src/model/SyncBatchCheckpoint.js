...
/**
 * The SyncBatchCheckpoint model module.
 * @module model/SyncBatchCheckpoint
 * @version 1.0.0
 */
class SyncBatchCheckpoint {
    /**
     * Constructs a new <code>SyncBatchCheckpoint</code>.
     * @alias module:model/SyncBatchCheckpoint
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>SyncBatchCheckpoint</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SyncBatchCheckpoint} obj Optional instance to populate.
     * @return {module:model/SyncBatchCheckpoint} The populated <code>SyncBatchCheckpoint</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SyncBatchCheckpoint();

            if (data.hasOwnProperty('checkpoint')) {
                obj['checkpoint'] = ApiClient.convertToType(data['checkpoint'], 'Blob');
            }
        }
        return obj;
    }
...
export default SyncBatchCheckpoint;
