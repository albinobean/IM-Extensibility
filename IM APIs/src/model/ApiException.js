    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('error')) {
                obj['error'] = ErrorCode.constructFromObject(data['error']);
            }
        }
        return obj;
    }
 ...
 */
ApiException.prototype['error_description'] = undefined;

/**
 * @member {module:model/ErrorCode} error
 */
ApiException.prototype['error'] = undefined;
