...
/**
 * The UserAccountDTODashboardGroups model module.
 * @module model/UserAccountDTODashboardGroups
 * @version 1.0.0
 */
class UserAccountDTODashboardGroups {
    /**
     * Constructs a new <code>UserAccountDTODashboardGroups</code>.
     * @alias module:model/UserAccountDTODashboardGroups
     */
    constructor() { 
        
        UserAccountDTODashboardGroups.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UserAccountDTODashboardGroups</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UserAccountDTODashboardGroups} obj Optional instance to populate.
     * @return {module:model/UserAccountDTODashboardGroups} The populated <code>UserAccountDTODashboardGroups</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserAccountDTODashboardGroups();
 ...
 * @member {String} name
 */
UserAccountDTODashboardGroups.prototype['name'] = undefined;

/**
 * @member {Number} id
 */
UserAccountDTODashboardGroups.prototype['id'] = undefined;
...
export default UserAccountDTODashboardGroups;
