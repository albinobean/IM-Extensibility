...
/**
 * The ContactDTOAddress model module.
 * @module model/ContactDTOAddress
 * @version 1.0.0
 */
class ContactDTOAddress {
    /**
     * Constructs a new <code>ContactDTOAddress</code>.
     * Address of the contact.
     * @alias module:model/ContactDTOAddress
     */
    constructor() { 
        
        ContactDTOAddress.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContactDTOAddress</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContactDTOAddress} obj Optional instance to populate.
     * @return {module:model/ContactDTOAddress} The populated <code>ContactDTOAddress</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContactDTOAddress();
 ...
 * @member {String} line1
 */
ContactDTOAddress.prototype['line1'] = undefined;

/**
 * Second line of the address.
 * @member {String} line2
 */
ContactDTOAddress.prototype['line2'] = undefined;

/**
 * City of the address.
 * @member {String} city
 */
ContactDTOAddress.prototype['city'] = undefined;

/**
 * State of the address.
 * @member {String} state
 */
ContactDTOAddress.prototype['state'] = undefined;

/**
 * Country of the address.
 * @member {String} country
 */
ContactDTOAddress.prototype['country'] = undefined;

/**
 * Postal Code of the address.
 * @member {String} postalCode
 */
ContactDTOAddress.prototype['postalCode'] = undefined;
...
export default ContactDTOAddress;
