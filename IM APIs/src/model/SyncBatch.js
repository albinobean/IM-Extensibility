...
import SyncBatchCheckpoint from './SyncBatchCheckpoint';

/**
 * The SyncBatch model module.
 * @module model/SyncBatch
 * @version 1.0.0
 */
class SyncBatch {
    /**
     * Constructs a new <code>SyncBatch</code>.
     * @alias module:model/SyncBatch
     * @extends module:model/SyncBatchCheckpoint
     * @implements module:model/SyncBatchCheckpoint
     */
    constructor() { 
        SyncBatchCheckpoint.initialize(this);
        SyncBatch.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SyncBatch</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SyncBatch} obj Optional instance to populate.
     * @return {module:model/SyncBatch} The populated <code>SyncBatch</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SyncBatch();
            SyncBatchCheckpoint.constructFromObject(data, obj);
            SyncBatchCheckpoint.constructFromObject(data, obj);
...
// Implement SyncBatchCheckpoint interface:
/**
 * @member {Blob} checkpoint
 */
SyncBatchCheckpoint.prototype['checkpoint'] = undefined;
