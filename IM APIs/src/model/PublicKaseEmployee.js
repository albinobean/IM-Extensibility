...
/**
 * The PublicKaseEmployee model module.
 * @module model/PublicKaseEmployee
 * @version 1.0.0
 */
class PublicKaseEmployee {
    /**
     * Constructs a new <code>PublicKaseEmployee</code>.
     * @alias module:model/PublicKaseEmployee
     */
    constructor() { 
        
        PublicKaseEmployee.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PublicKaseEmployee</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PublicKaseEmployee} obj Optional instance to populate.
     * @return {module:model/PublicKaseEmployee} The populated <code>PublicKaseEmployee</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PublicKaseEmployee();
 ...
 * @member {String} email
 */
PublicKaseEmployee.prototype['email'] = undefined;

/**
 * @member {String} firstName
 */
PublicKaseEmployee.prototype['firstName'] = undefined;

/**
 * @member {String} lastName
 */
PublicKaseEmployee.prototype['lastName'] = undefined;
...
export default PublicKaseEmployee;
