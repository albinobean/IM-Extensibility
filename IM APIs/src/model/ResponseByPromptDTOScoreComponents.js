...
/**
 * The ResponseByPromptDTOScoreComponents model module.
 * @module model/ResponseByPromptDTOScoreComponents
 * @version 1.0.0
 */
class ResponseByPromptDTOScoreComponents {
    /**
     * Constructs a new <code>ResponseByPromptDTOScoreComponents</code>.
     * @alias module:model/ResponseByPromptDTOScoreComponents
     */
    constructor() { 
        
        ResponseByPromptDTOScoreComponents.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ResponseByPromptDTOScoreComponents</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResponseByPromptDTOScoreComponents} obj Optional instance to populate.
     * @return {module:model/ResponseByPromptDTOScoreComponents} The populated <code>ResponseByPromptDTOScoreComponents</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResponseByPromptDTOScoreComponents();
 ...
 */
ResponseByPromptDTOScoreComponents.prototype['fieldId'] = undefined;

/**
 * @member {Number} points
 */
ResponseByPromptDTOScoreComponents.prototype['points'] = undefined;

/**
 * @member {Number} weight
 */
ResponseByPromptDTOScoreComponents.prototype['weight'] = undefined;
...
export default ResponseByPromptDTOScoreComponents;
