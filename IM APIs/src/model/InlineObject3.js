...
import SurveyInitInboundPhoneParameters from './SurveyInitInboundPhoneParameters';
...
class InlineObject3 {
     ...
     * @param gatewayAlias {String} The alias of a inbound phone survey gateway.
     */
    constructor(gatewayAlias) { 
        
        InlineObject3.initialize(this, gatewayAlias);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('parameters')) {
                obj['parameters'] = ApiClient.convertToType(data['parameters'], [SurveyInitInboundPhoneParameters]);
            }
        }
        return obj;
    }
...
/**
 * The alias of a inbound phone survey gateway.
 * @member {String} gatewayAlias
 */
InlineObject3.prototype['gatewayAlias'] = undefined;

/**
 * @member {Array.<module:model/SurveyInitInboundPhoneParameters>} parameters
 */
InlineObject3.prototype['parameters'] = undefined;
