...
/**
 * The SpitRateCountDTO model module.
 * @module model/SpitRateCountDTO
 * @version 1.0.0
 */
class SpitRateCountDTO {
    /**
     * Constructs a new <code>SpitRateCountDTO</code>.
     * @alias module:model/SpitRateCountDTO
     */
    constructor() { 
        
        SpitRateCountDTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SpitRateCountDTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SpitRateCountDTO} obj Optional instance to populate.
     * @return {module:model/SpitRateCountDTO} The populated <code>SpitRateCountDTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SpitRateCountDTO();
            ...
            if (data.hasOwnProperty('lastSpitRateCount')) {
                obj['lastSpitRateCount'] = ApiClient.convertToType(data['lastSpitRateCount'], 'Number');
            }
            if (data.hasOwnProperty('spitRateTimestamp')) {
                obj['spitRateTimestamp'] = ApiClient.convertToType(data['spitRateTimestamp'], 'Date');
            }
        }
        return obj;
    }
 ...
 */
SpitRateCountDTO.prototype['unitNumber'] = undefined;

/**
 * @member {Number} periodCount
 */
SpitRateCountDTO.prototype['periodCount'] = undefined;

/**
 * @member {Number} lastSpitRateCount
 */
SpitRateCountDTO.prototype['lastSpitRateCount'] = undefined;

/**
 * @member {Date} spitRateTimestamp
 */
SpitRateCountDTO.prototype['spitRateTimestamp'] = undefined;
...
export default SpitRateCountDTO;
