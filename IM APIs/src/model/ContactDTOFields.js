...
/**
 * The ContactDTOFields model module.
 * @module model/ContactDTOFields
 * @version 1.0.0
 */
class ContactDTOFields {
    /**
     * Constructs a new <code>ContactDTOFields</code>.
     * @alias module:model/ContactDTOFields
     */
    constructor() { 
        
        ContactDTOFields.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContactDTOFields</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContactDTOFields} obj Optional instance to populate.
     * @return {module:model/ContactDTOFields} The populated <code>ContactDTOFields</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContactDTOFields();
...
/**
 * ID of the DataField. Must be a CrmField in the organization of the contact.
 * @member {Number} fieldId
 */
ContactDTOFields.prototype['fieldId'] = undefined;

/**
 * @member {Object} value
 */
ContactDTOFields.prototype['value'] = undefined;
...
export default ContactDTOFields;
