...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.TagDTO();
  });
  ...
  describe('TagDTO', function() {
    it('should create an instance of TagDTO', function() {
      // uncomment below and update the code to test TagDTO
      //var instane = new InMomentPublicRestApi.TagDTO();
      //expect(instance).to.be.a(InMomentPublicRestApi.TagDTO);
    });
    ...
    it('should have the property tagCategory (base name: "tagCategory")', function() {
      // uncomment below and update the code to test the property tagCategory
      //var instane = new InMomentPublicRestApi.TagDTO();
      //expect(instance).to.be();
    });
    ...
    it('should have the property visibleInInbox (base name: "visibleInInbox")', function() {
      // uncomment below and update the code to test the property visibleInInbox
      //var instane = new InMomentPublicRestApi.TagDTO();
      //expect(instance).to.be();
    });
