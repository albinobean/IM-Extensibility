...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.ApiResultDTO();
  });
  ...
  describe('ApiResultDTO', function() {
    it('should create an instance of ApiResultDTO', function() {
      // uncomment below and update the code to test ApiResultDTO
      //var instane = new InMomentPublicRestApi.ApiResultDTO();
      //expect(instance).to.be.a(InMomentPublicRestApi.ApiResultDTO);
    });
