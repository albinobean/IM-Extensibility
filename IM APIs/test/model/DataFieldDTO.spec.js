...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.DataFieldDTO();
  });
  ...
  describe('DataFieldDTO', function() {
    it('should create an instance of DataFieldDTO', function() {
      // uncomment below and update the code to test DataFieldDTO
      //var instane = new InMomentPublicRestApi.DataFieldDTO();
      //expect(instance).to.be.a(InMomentPublicRestApi.DataFieldDTO);
    });
