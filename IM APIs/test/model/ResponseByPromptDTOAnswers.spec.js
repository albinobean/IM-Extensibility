...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.ResponseByPromptDTOAnswers();
  });
  ...
  describe('ResponseByPromptDTOAnswers', function() {
    it('should create an instance of ResponseByPromptDTOAnswers', function() {
      // uncomment below and update the code to test ResponseByPromptDTOAnswers
      //var instane = new InMomentPublicRestApi.ResponseByPromptDTOAnswers();
      //expect(instance).to.be.a(InMomentPublicRestApi.ResponseByPromptDTOAnswers);
    });
    ...
    it('should have the property answerValue (base name: "answerValue")', function() {
