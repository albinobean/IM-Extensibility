...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.ResponseByPromptDTOScoreComponents();
  });
  ...
  describe('ResponseByPromptDTOScoreComponents', function() {
    it('should create an instance of ResponseByPromptDTOScoreComponents', function() {
      // uncomment below and update the code to test ResponseByPromptDTOScoreComponents
      //var instane = new InMomentPublicRestApi.ResponseByPromptDTOScoreComponents();
      //expect(instance).to.be.a(InMomentPublicRestApi.ResponseByPromptDTOScoreComponents);
    });
