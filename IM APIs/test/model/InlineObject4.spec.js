...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.InlineObject4();
  });
  ...
  describe('InlineObject4', function() {
    it('should create an instance of InlineObject4', function() {
      ...
      //var instane = new InMomentPublicRestApi.InlineObject4();
      //expect(instance).to.be.a(InMomentPublicRestApi.InlineObject4);
    });
    ...
    it('should have the property expireHours (base name: "expireHours")', function() {
      // uncomment below and update the code to test the property expireHours
      //var instane = new InMomentPublicRestApi.InlineObject4();
      //expect(instance).to.be();
    });
