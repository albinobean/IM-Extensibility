...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.ContactDTOName();
  });
  ...
  describe('ContactDTOName', function() {
    it('should create an instance of ContactDTOName', function() {
      // uncomment below and update the code to test ContactDTOName
      //var instane = new InMomentPublicRestApi.ContactDTOName();
      //expect(instance).to.be.a(InMomentPublicRestApi.ContactDTOName);
    });
