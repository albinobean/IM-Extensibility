...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.ResponseDTOScores();
  });
  ...
  describe('ResponseDTOScores', function() {
    it('should create an instance of ResponseDTOScores', function() {
      // uncomment below and update the code to test ResponseDTOScores
      //var instane = new InMomentPublicRestApi.ResponseDTOScores();
      //expect(instance).to.be.a(InMomentPublicRestApi.ResponseDTOScores);
    });
