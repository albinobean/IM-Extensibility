...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.PublicKasePage();
  });
  ...
  describe('PublicKasePage', function() {
    it('should create an instance of PublicKasePage', function() {
      // uncomment below and update the code to test PublicKasePage
      //var instane = new InMomentPublicRestApi.PublicKasePage();
      //expect(instance).to.be.a(InMomentPublicRestApi.PublicKasePage);
    });
