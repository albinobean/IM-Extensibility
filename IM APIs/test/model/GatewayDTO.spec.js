...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.GatewayDTO();
  });
  ...
  describe('GatewayDTO', function() {
    it('should create an instance of GatewayDTO', function() {
      // uncomment below and update the code to test GatewayDTO
      //var instane = new InMomentPublicRestApi.GatewayDTO();
      //expect(instance).to.be.a(InMomentPublicRestApi.GatewayDTO);
    });
