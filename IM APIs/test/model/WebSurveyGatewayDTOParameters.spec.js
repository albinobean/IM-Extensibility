...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.WebSurveyGatewayDTOParameters();
  });
  ...
  describe('WebSurveyGatewayDTOParameters', function() {
    it('should create an instance of WebSurveyGatewayDTOParameters', function() {
      // uncomment below and update the code to test WebSurveyGatewayDTOParameters
      //var instane = new InMomentPublicRestApi.WebSurveyGatewayDTOParameters();
      //expect(instance).to.be.a(InMomentPublicRestApi.WebSurveyGatewayDTOParameters);
    });
    ...
    it('should have the property promptName (base name: "promptName")', function() {
      // uncomment below and update the code to test the property promptName
      //var instane = new InMomentPublicRestApi.WebSurveyGatewayDTOParameters();
      //expect(instance).to.be();
    });
    ...
    it('should have the property defaultParamValue (base name: "defaultParamValue")', function() {
      // uncomment below and update the code to test the property defaultParamValue
      //var instane = new InMomentPublicRestApi.WebSurveyGatewayDTOParameters();
      //expect(instance).to.be();
    });
