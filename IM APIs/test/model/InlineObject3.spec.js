...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.InlineObject3();
  });
  ...
  describe('InlineObject3', function() {
    it('should create an instance of InlineObject3', function() {
      ...
      //var instane = new InMomentPublicRestApi.InlineObject3();
      //expect(instance).to.be.a(InMomentPublicRestApi.InlineObject3);
    });
