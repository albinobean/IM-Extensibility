...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.SyncBatchCheckpoint();
  });
  ...
  describe('SyncBatchCheckpoint', function() {
    it('should create an instance of SyncBatchCheckpoint', function() {
      // uncomment below and update the code to test SyncBatchCheckpoint
      //var instane = new InMomentPublicRestApi.SyncBatchCheckpoint();
      //expect(instance).to.be.a(InMomentPublicRestApi.SyncBatchCheckpoint);
    });

    it('should have the property checkpoint (base name: "checkpoint")', function() {
      // uncomment below and update the code to test the property checkpoint
      //var instane = new InMomentPublicRestApi.SyncBatchCheckpoint();
