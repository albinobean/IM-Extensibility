...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.OptionDTO();
  });
  ...
  describe('OptionDTO', function() {
    it('should create an instance of OptionDTO', function() {
      // uncomment below and update the code to test OptionDTO
      //var instane = new InMomentPublicRestApi.OptionDTO();
      //expect(instance).to.be.a(InMomentPublicRestApi.OptionDTO);
    });
    ...
    it('should have the property ordinalLevel (base name: "ordinalLevel")', function() {
      // uncomment below and update the code to test the property ordinalLevel
      //var instane = new InMomentPublicRestApi.OptionDTO();
      //expect(instance).to.be();
    });
