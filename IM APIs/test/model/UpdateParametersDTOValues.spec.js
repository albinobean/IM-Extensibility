...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.UpdateParametersDTOValues();
  });
  ...
  describe('UpdateParametersDTOValues', function() {
    it('should create an instance of UpdateParametersDTOValues', function() {
      // uncomment below and update the code to test UpdateParametersDTOValues
      //var instane = new InMomentPublicRestApi.UpdateParametersDTOValues();
      //expect(instance).to.be.a(InMomentPublicRestApi.UpdateParametersDTOValues);
    });
