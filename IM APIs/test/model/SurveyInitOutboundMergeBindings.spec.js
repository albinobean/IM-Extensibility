...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.SurveyInitOutboundMergeBindings();
  });
  ...
  describe('SurveyInitOutboundMergeBindings', function() {
    it('should create an instance of SurveyInitOutboundMergeBindings', function() {
      // uncomment below and update the code to test SurveyInitOutboundMergeBindings
      //var instane = new InMomentPublicRestApi.SurveyInitOutboundMergeBindings();
      //expect(instance).to.be.a(InMomentPublicRestApi.SurveyInitOutboundMergeBindings);
    });
