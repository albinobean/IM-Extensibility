...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.SurveyInitInboundPhoneParameters();
  });
  ...
  describe('SurveyInitInboundPhoneParameters', function() {
    it('should create an instance of SurveyInitInboundPhoneParameters', function() {
      // uncomment below and update the code to test SurveyInitInboundPhoneParameters
      //var instane = new InMomentPublicRestApi.SurveyInitInboundPhoneParameters();
      //expect(instance).to.be.a(InMomentPublicRestApi.SurveyInitInboundPhoneParameters);
    });
