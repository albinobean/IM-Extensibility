...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.ContactDTOAddress();
  });
  ...
  describe('ContactDTOAddress', function() {
    it('should create an instance of ContactDTOAddress', function() {
      // uncomment below and update the code to test ContactDTOAddress
      //var instane = new InMomentPublicRestApi.ContactDTOAddress();
      //expect(instance).to.be.a(InMomentPublicRestApi.ContactDTOAddress);
    });
