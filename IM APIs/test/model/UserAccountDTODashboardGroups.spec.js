...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.UserAccountDTODashboardGroups();
  });
  ...
  describe('UserAccountDTODashboardGroups', function() {
    it('should create an instance of UserAccountDTODashboardGroups', function() {
      // uncomment below and update the code to test UserAccountDTODashboardGroups
      //var instane = new InMomentPublicRestApi.UserAccountDTODashboardGroups();
      //expect(instance).to.be.a(InMomentPublicRestApi.UserAccountDTODashboardGroups);
    });
