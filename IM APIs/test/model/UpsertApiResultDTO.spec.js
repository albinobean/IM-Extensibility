...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.UpsertApiResultDTO();
  });
  ...
  describe('UpsertApiResultDTO', function() {
    it('should create an instance of UpsertApiResultDTO', function() {
      // uncomment below and update the code to test UpsertApiResultDTO
      //var instane = new InMomentPublicRestApi.UpsertApiResultDTO();
      //expect(instance).to.be.a(InMomentPublicRestApi.UpsertApiResultDTO);
    });
