...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.CaseOrgOrgIdCasesCreationTime();
  });
  ...
  describe('CaseOrgOrgIdCasesCreationTime', function() {
    it('should create an instance of CaseOrgOrgIdCasesCreationTime', function() {
      // uncomment below and update the code to test CaseOrgOrgIdCasesCreationTime
      //var instane = new InMomentPublicRestApi.CaseOrgOrgIdCasesCreationTime();
      //expect(instance).to.be.a(InMomentPublicRestApi.CaseOrgOrgIdCasesCreationTime);
    });
