...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.InlineObject5();
  });
  ...
  describe('InlineObject5', function() {
    it('should create an instance of InlineObject5', function() {
      ...
      //var instane = new InMomentPublicRestApi.InlineObject5();
      //expect(instance).to.be.a(InMomentPublicRestApi.InlineObject5);
    });

    it('should have the property gatewayAlias (base name: "gatewayAlias")', function() {
      // uncomment below and update the code to test the property gatewayAlias
      //var instane = new InMomentPublicRestApi.InlineObject5();
    ...
    it('should have the property secondaryPhoneNumber (base name: "secondaryPhoneNumber")', function() {
    ...
    it('should have the property mergeBindings (base name: "mergeBindings")', function() {
      // uncomment below and update the code to test the property mergeBindings
      //var instane = new InMomentPublicRestApi.InlineObject5();
      //expect(instance).to.be();
    });
