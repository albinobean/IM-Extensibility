...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.ResponseDTOSocialReviewRatings();
  });
  ...
  describe('ResponseDTOSocialReviewRatings', function() {
    it('should create an instance of ResponseDTOSocialReviewRatings', function() {
      // uncomment below and update the code to test ResponseDTOSocialReviewRatings
      //var instane = new InMomentPublicRestApi.ResponseDTOSocialReviewRatings();
      //expect(instance).to.be.a(InMomentPublicRestApi.ResponseDTOSocialReviewRatings);
    });
