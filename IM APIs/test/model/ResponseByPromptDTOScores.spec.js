...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.ResponseByPromptDTOScores();
  });
  ...
  describe('ResponseByPromptDTOScores', function() {
    it('should create an instance of ResponseByPromptDTOScores', function() {
      // uncomment below and update the code to test ResponseByPromptDTOScores
      //var instane = new InMomentPublicRestApi.ResponseByPromptDTOScores();
      //expect(instance).to.be.a(InMomentPublicRestApi.ResponseByPromptDTOScores);
    });
    ...
    it('should have the property scoreFieldId (base name: "scoreFieldId")', function() {
      // uncomment below and update the code to test the property scoreFieldId
      //var instane = new InMomentPublicRestApi.ResponseByPromptDTOScores();
      //expect(instance).to.be();
    });
    ...
    it('should have the property pointsPossible (base name: "pointsPossible")', function() {
      // uncomment below and update the code to test the property pointsPossible
      //var instane = new InMomentPublicRestApi.ResponseByPromptDTOScores();
      //expect(instance).to.be();
    });
    ...
    it('should have the property scoreComponents (base name: "scoreComponents")', function() {
      // uncomment below and update the code to test the property scoreComponents
      //var instane = new InMomentPublicRestApi.ResponseByPromptDTOScores();
      //expect(instance).to.be();
    });
