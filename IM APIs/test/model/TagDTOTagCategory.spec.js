...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.TagDTOTagCategory();
  });
  ...
  describe('TagDTOTagCategory', function() {
    it('should create an instance of TagDTOTagCategory', function() {
      // uncomment below and update the code to test TagDTOTagCategory
      //var instane = new InMomentPublicRestApi.TagDTOTagCategory();
      //expect(instance).to.be.a(InMomentPublicRestApi.TagDTOTagCategory);
    });
