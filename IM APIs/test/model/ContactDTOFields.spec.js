...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.ContactDTOFields();
  });
  ...
  describe('ContactDTOFields', function() {
    it('should create an instance of ContactDTOFields', function() {
      // uncomment below and update the code to test ContactDTOFields
      //var instane = new InMomentPublicRestApi.ContactDTOFields();
      //expect(instance).to.be.a(InMomentPublicRestApi.ContactDTOFields);
    });
