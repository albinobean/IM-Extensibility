...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.UserAccountDTO();
  });
  ...
  describe('UserAccountDTO', function() {
    it('should create an instance of UserAccountDTO', function() {
      // uncomment below and update the code to test UserAccountDTO
      //var instane = new InMomentPublicRestApi.UserAccountDTO();
      //expect(instance).to.be.a(InMomentPublicRestApi.UserAccountDTO);
    });
