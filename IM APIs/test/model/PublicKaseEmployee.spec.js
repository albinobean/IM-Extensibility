...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.PublicKaseEmployee();
  });
  ...
  describe('PublicKaseEmployee', function() {
    it('should create an instance of PublicKaseEmployee', function() {
      // uncomment below and update the code to test PublicKaseEmployee
      //var instane = new InMomentPublicRestApi.PublicKaseEmployee();
      //expect(instance).to.be.a(InMomentPublicRestApi.PublicKaseEmployee);
    });
