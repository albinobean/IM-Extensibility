...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.InlineObject();
  });
  ...
  describe('InlineObject', function() {
    it('should create an instance of InlineObject', function() {
      ...
      //var instane = new InMomentPublicRestApi.InlineObject();
      //expect(instance).to.be.a(InMomentPublicRestApi.InlineObject);
    });
