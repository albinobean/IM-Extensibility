...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.UserAccountDTOLocale();
  });
  ...
  describe('UserAccountDTOLocale', function() {
    it('should create an instance of UserAccountDTOLocale', function() {
      // uncomment below and update the code to test UserAccountDTOLocale
      //var instane = new InMomentPublicRestApi.UserAccountDTOLocale();
      //expect(instance).to.be.a(InMomentPublicRestApi.UserAccountDTOLocale);
    });
