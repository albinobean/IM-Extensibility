...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.SyncBatch();
  });
  ...
  describe('SyncBatch', function() {
    it('should create an instance of SyncBatch', function() {
      // uncomment below and update the code to test SyncBatch
      //var instane = new InMomentPublicRestApi.SyncBatch();
      //expect(instance).to.be.a(InMomentPublicRestApi.SyncBatch);
    });
