...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.InlineObject1();
  });
  ...
  describe('InlineObject1', function() {
    it('should create an instance of InlineObject1', function() {
      ...
      //var instane = new InMomentPublicRestApi.InlineObject1();
      //expect(instance).to.be.a(InMomentPublicRestApi.InlineObject1);
    });

    it('should have the property organizationObjectId (base name: "organizationObjectId")', function() {
      // uncomment below and update the code to test the property organizationObjectId
      //var instane = new InMomentPublicRestApi.InlineObject1();
      //expect(instance).to.be();
    });

    it('should have the property feedbackChannelId (base name: "feedbackChannelId")', function() {
      // uncomment below and update the code to test the property feedbackChannelId
      //var instane = new InMomentPublicRestApi.InlineObject1();
      //expect(instance).to.be();
    });

    it('should have the property periodBeginDate (base name: "periodBeginDate")', function() {
      // uncomment below and update the code to test the property periodBeginDate
      //var instane = new InMomentPublicRestApi.InlineObject1();
      //expect(instance).to.be();
    });
