...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.UpsertParametersDTO();
  });
  ...
  describe('UpsertParametersDTO', function() {
    it('should create an instance of UpsertParametersDTO', function() {
      // uncomment below and update the code to test UpsertParametersDTO
      //var instane = new InMomentPublicRestApi.UpsertParametersDTO();
      //expect(instance).to.be.a(InMomentPublicRestApi.UpsertParametersDTO);
    });
