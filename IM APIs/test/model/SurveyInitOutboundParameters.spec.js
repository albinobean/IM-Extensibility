...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.SurveyInitOutboundParameters();
  });
  ...
  describe('SurveyInitOutboundParameters', function() {
    it('should create an instance of SurveyInitOutboundParameters', function() {
      // uncomment below and update the code to test SurveyInitOutboundParameters
      //var instane = new InMomentPublicRestApi.SurveyInitOutboundParameters();
      //expect(instance).to.be.a(InMomentPublicRestApi.SurveyInitOutboundParameters);
    });
