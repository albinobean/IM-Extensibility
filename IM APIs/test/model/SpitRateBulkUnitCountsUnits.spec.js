...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.SpitRateBulkUnitCountsUnits();
  });
  ...
  describe('SpitRateBulkUnitCountsUnits', function() {
    it('should create an instance of SpitRateBulkUnitCountsUnits', function() {
      // uncomment below and update the code to test SpitRateBulkUnitCountsUnits
      //var instane = new InMomentPublicRestApi.SpitRateBulkUnitCountsUnits();
      //expect(instance).to.be.a(InMomentPublicRestApi.SpitRateBulkUnitCountsUnits);
    });
    ...
    it('should have the property lastSpitRateDate (base name: "lastSpitRateDate")', function() {
      // uncomment below and update the code to test the property lastSpitRateDate
      //var instane = new InMomentPublicRestApi.SpitRateBulkUnitCountsUnits();
      //expect(instance).to.be();
    });
