...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.AnyValue();
  });
  ...
  describe('AnyValue', function() {
    it('should create an instance of AnyValue', function() {
      // uncomment below and update the code to test AnyValue
      //var instane = new InMomentPublicRestApi.AnyValue();
      //expect(instance).to.be.a(InMomentPublicRestApi.AnyValue);
    });
