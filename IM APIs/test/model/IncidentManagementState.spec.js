...
(function(root, factory) {
  ...
  describe('IncidentManagementState', function() {
    it('should create an instance of IncidentManagementState', function() {
      // uncomment below and update the code to test IncidentManagementState
      //var instane = new InMomentPublicRestApi.IncidentManagementState();
      //expect(instance).to.be.a(InMomentPublicRestApi.IncidentManagementState);
    });
