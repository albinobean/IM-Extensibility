...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.IncidentDTO();
  });
  ...
  describe('IncidentDTO', function() {
    it('should create an instance of IncidentDTO', function() {
      ...
      //var instane = new InMomentPublicRestApi.IncidentDTO();
      //expect(instance).to.be.a(InMomentPublicRestApi.IncidentDTO);
    });
    ...
    it('should have the property userAccountFirstName (base name: "userAccountFirstName")', function() {
      // uncomment below and update the code to test the property userAccountFirstName
      //var instane = new InMomentPublicRestApi.IncidentDTO();
      //expect(instance).to.be();
    });

    it('should have the property userAccountLastName (base name: "userAccountLastName")', function() {
      // uncomment below and update the code to test the property userAccountLastName
      //var instane = new InMomentPublicRestApi.IncidentDTO();
      //expect(instance).to.be();
    });

    it('should have the property userAccountEmail (base name: "userAccountEmail")', function() {
      // uncomment below and update the code to test the property userAccountEmail
      //var instane = new InMomentPublicRestApi.IncidentDTO();
      //expect(instance).to.be();
    });
