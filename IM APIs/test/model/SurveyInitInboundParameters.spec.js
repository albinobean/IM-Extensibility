...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.SurveyInitInboundParameters();
  });
  ...
  describe('SurveyInitInboundParameters', function() {
    it('should create an instance of SurveyInitInboundParameters', function() {
      // uncomment below and update the code to test SurveyInitInboundParameters
      //var instane = new InMomentPublicRestApi.SurveyInitInboundParameters();
      //expect(instance).to.be.a(InMomentPublicRestApi.SurveyInitInboundParameters);
    });
