...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.ApiException();
  });
  ...
  describe('ApiException', function() {
    it('should create an instance of ApiException', function() {
      ...
      //var instane = new InMomentPublicRestApi.ApiException();
      //expect(instance).to.be.a(InMomentPublicRestApi.ApiException);
    });
