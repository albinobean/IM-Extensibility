...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.LocalizedStringDTO();
  });
  ...
  describe('LocalizedStringDTO', function() {
    it('should create an instance of LocalizedStringDTO', function() {
      // uncomment below and update the code to test LocalizedStringDTO
      //var instane = new InMomentPublicRestApi.LocalizedStringDTO();
      //expect(instance).to.be.a(InMomentPublicRestApi.LocalizedStringDTO);
    });
