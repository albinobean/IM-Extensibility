...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.ContactsApi();
  });
  ...
  describe('ContactsApi', function() {
    describe('contactCreateContact', function() {
      it('should call contactCreateContact successfully', function(done) {
        //uncomment below and update the code to test contactCreateContact
        //instance.contactCreateContact(function(error) {
    ...
    describe('contactFindByChangesSince', function() {
      it('should call contactFindByChangesSince successfully', function(done) {
        //uncomment below and update the code to test contactFindByChangesSince
        //instance.contactFindByChangesSince(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('contactUpdateContact', function() {
      it('should call contactUpdateContact successfully', function(done) {
        //uncomment below and update the code to test contactUpdateContact
        //instance.contactUpdateContact(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('contactUpsertContact', function() {
      it('should call contactUpsertContact successfully', function(done) {
        //uncomment below and update the code to test contactUpsertContact
        //instance.contactUpsertContact(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getContactByContactId', function() {
      it('should call getContactByContactId successfully', function(done) {
        //uncomment below and update the code to test getContactByContactId
        //instance.getContactByContactId(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
