...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.CaseManagementApi();
  });
  ...
  describe('CaseManagementApi', function() {
    describe('caseGetCases', function() {
      it('should call caseGetCases successfully', function(done) {
        //uncomment below and update the code to test caseGetCases
        //instance.caseGetCases(function(error) {
    ...
    describe('caseGetCasesWithFilter', function() {
      it('should call caseGetCasesWithFilter successfully', function(done) {
        //uncomment below and update the code to test caseGetCasesWithFilter
        //instance.caseGetCasesWithFilter(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
