...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InMomentPublicRestApi.RequestsApi();
  });
  ...
  describe('RequestsApi', function() {
    describe('initiateInboundPhoneSurvey', function() {
      it('should call initiateInboundPhoneSurvey successfully', function(done) {
        //uncomment below and update the code to test initiateInboundPhoneSurvey
        //instance.initiateInboundPhoneSurvey(function(error) {
    ...
    describe('initiateInboundSurvey', function() {
      it('should call initiateInboundSurvey successfully', function(done) {
        //uncomment below and update the code to test initiateInboundSurvey
        //instance.initiateInboundSurvey(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('initiateOutboundSurvey', function() {
      it('should call initiateOutboundSurvey successfully', function(done) {
        //uncomment below and update the code to test initiateOutboundSurvey
        //instance.initiateOutboundSurvey(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
